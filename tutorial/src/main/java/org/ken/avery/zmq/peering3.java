...
public class peering3
{
    ...
    private static class client_task extends Thread
    {
        ...
        public void run()
        {
            ...
            while (true)
            {
                ...
                while (burst > 0)
                {
                    final String taskId = String.format("%04X", rand.nextInt(10000));
                    //  Send request, get reply
                    client.send(taskId, 0);

                    //  Wait max ten seconds for a reply, then complain
                    final PollItem pollSet[] = {
    ...
    public static void main(final String[] argv)
    {
        ...
        int localCapacity = 0;
        int cloudCapacity = 0;
        final ArrayList<ZFrame> workers = new ArrayList<ZFrame>();
