...
public class kvmsg
{
    ...
    private void decodeProps()
    {
        ...
        for (final String prop : new String(msg).split("\n"))
        {
    ...
    {
        final String value = String.format(fmt, args);
    ...
    public void test(final boolean verbose)
    {
        ...
        final Map<String, kvmsg> kvmap = new HashMap<String, kvmsg>();
        ...
        kvmsg = org.ken.avery.zmq.kvmsg.recv(input);
        if (verbose)
        {
            kvmsg.dump();
        }
